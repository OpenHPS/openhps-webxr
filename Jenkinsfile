pipeline {
    ...
    post {
        always {
            ...
            archiveArtifacts artifacts: 'dist/web/openhps-webxr.js', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-webxr.js.map', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-webxr.min.js', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-webxr.min.js.map', fingerprint: true
            deleteDir()
        }
    }
}